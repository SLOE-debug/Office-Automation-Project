...
var TypeScriptWorker = /** @class */ (function () {
  ...
  TypeScriptWorker.prototype.getScriptFileNames = function () {
    var allModels = this._ctx.getMirrorModels().map(function (model) {
      return model.uri;
    });
    var models = allModels
      .filter(function (uri) {
        return !fileNameIsLib(uri);
      })
      .map(function (uri) {
        return uri.toString();
      });
  ...
  TypeScriptWorker.clearFiles = function (tsDiagnostics) {
    ...
    var diagnostics = [];
    for (
      var _i = 0, tsDiagnostics_1 = tsDiagnostics;
      _i < tsDiagnostics_1.length;
      _i++
    ) {
      ...
      if (tsDiagnostic.relatedInformation) {
        ...
        for (
          var _a = 0, _b = tsDiagnostic.relatedInformation;
          _a < _b.length;
          _a++
        ) {
  ...
  TypeScriptWorker.prototype.getCompilerOptionsDiagnostics = function (
    fileName
  ) {
    return __awaiter(this, void 0, void 0, function () {
      var diagnostics;
  ...
  TypeScriptWorker.prototype.getCompletionsAtPosition = function (
    fileName,
    position
  ) {
    return __awaiter(this, void 0, void 0, function () {
  ...
  TypeScriptWorker.prototype.getCompletionEntryDetails = function (
    fileName,
    position,
    entry
  ) {
  ...
  TypeScriptWorker.prototype.getSignatureHelpItems = function (
    fileName,
    position,
    options
  ) {
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_a) {
        ...
        return [
          2 /*return*/,
          this._languageService.getSignatureHelpItems(
            fileName,
            position,
            options
          ),
  ...
  TypeScriptWorker.prototype.getQuickInfoAtPosition = function (
    fileName,
    position
  ) {
    return __awaiter(this, void 0, void 0, function () {
  ...
  TypeScriptWorker.prototype.getOccurrencesAtPosition = function (
    fileName,
    position
  ) {
    return __awaiter(this, void 0, void 0, function () {
  ...
  TypeScriptWorker.prototype.getDefinitionAtPosition = function (
    fileName,
    position
  ) {
    return __awaiter(this, void 0, void 0, function () {
  ...
  TypeScriptWorker.prototype.getReferencesAtPosition = function (
    fileName,
    position
  ) {
    return __awaiter(this, void 0, void 0, function () {
  ...
  TypeScriptWorker.prototype.getFormattingEditsForDocument = function (
    fileName,
    options
  ) {
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_a) {
        ...
        return [
          2 /*return*/,
          this._languageService.getFormattingEditsForDocument(
            fileName,
            options
          ),
        ];
  ...
  TypeScriptWorker.prototype.getFormattingEditsForRange = function (
    fileName,
    start,
    end,
    options
  ...
  TypeScriptWorker.prototype.getFormattingEditsAfterKeystroke = function (
    fileName,
    postion,
    ch,
    options
  ...
  TypeScriptWorker.prototype.getRenameInfo = function (
    fileName,
    position,
    options
  ) {
  ...
  TypeScriptWorker.prototype.getCodeFixesAtPosition = function (
    fileName,
    start,
    end,
    errorCodes,
  ...
  TypeScriptWorker.prototype.provideInlayHints = function (
    fileName,
    start,
    end
  ) {
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_b) {
        ...
        preferences =
          (_a = this._inlayHintsOptions) !== null && _a !== void 0 ? _a : {};
        span = {
          start: start,
          length: end - start,
        };
        try {
          return [
            2 /*return*/,
            this._languageService.provideInlayHints(
              fileName,
              span,
              preferences
            ),
...
export class CustomTs2JsWorker extends TypeScriptWorker {
